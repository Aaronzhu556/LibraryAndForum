...
public class Article {
    ...
    private String article_user_img;
    private String article_time;
    private int article_click;


    private double article_hot;


    Article(){}


    public Article( int article_id,String article_title, String article_content, int article_reply_num, int article_star, String article_reply, String article_user_name, String article_time,int article_click){
