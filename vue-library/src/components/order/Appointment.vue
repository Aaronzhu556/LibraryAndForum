<template>
    <div>
        ...
        <el-card>
            ...
            <el-row :gutter="10">
                <el-col :span="6">
                    <el-input placeholder="请输入内容" v-model="queryInfo.querytext" :clearable="true" @clear="getAppointmentList">
                        <el-button slot="append" icon="el-icon-search" @click="getAppointmentList"></el-button>
                    </el-input>
                </el-col>
            </el-row>
